    ...
    <div className="flex h-screen flex-col overflow-hidden bg-surface-0 md:flex-row">
      ...
      <Dialog.Root open={drawerOpen} onOpenChange={setDrawerOpen}>
        <Dialog.Portal>
          ...
          >
            <Dialog.Close aria-label="Close navigation menu" className="absolute right-3 top-3 z-10 flex h-8 w-8 items-center justify-center rounded-lg text-text-muted transition-colors hover:bg-surface-3 hover:text-text-primary">
