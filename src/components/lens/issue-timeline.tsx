    ...
    <div className="space-y-1">
      <div className="mb-4 flex items-center justify-between">
        ...
        {!showForm && (
          <button
            onClick={() => setShowForm(true)}
            className="text-[10px] text-[#a8a29e] hover:text-[#44403c] transition-colors"
          >
            + Add event
          </button>
        )}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 pb-2">
                    <p className="text-xs font-medium text-[#1c1917] leading-snug">{event.title}</p>
                    {event.description && (
                      <p className="mt-0.5 text-[11px] text-[#a8a29e] leading-relaxed">
                        {event.description}
                      </p>
                    )}
                    <div className="mt-1 flex items-center gap-2">
                      <span className="text-[10px] text-[#a8a29e]">{event.eventDate}</span>
                      <span
      ...
      {showForm && (
        ...
        >
          <input
            ...
            className="w-full rounded-lg border px-3 py-2 text-xs bg-transparent text-[#1c1917] placeholder-[#a8a29e] focus:outline-none focus:border-[rgba(28,25,23,0.12)]"
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-lg border px-3 py-2 text-xs bg-transparent text-[#1c1917] focus:outline-none focus:border-[rgba(28,25,23,0.12)]"
              style={{ borderColor: '#e0ddd9' }}
            />
            <select
              value={formType}
          ...
          <textarea
            ...
            rows={2}
            className="w-full rounded-lg border px-3 py-2 text-xs bg-transparent text-[#1c1917] placeholder-[#a8a29e] focus:outline-none focus:border-[rgba(28,25,23,0.12)] resize-none"
            style={{ borderColor: '#e0ddd9' }}
          />
          <div className="flex items-center gap-2 justify-end">
            <button
              ...
              className="text-[10px] text-[#a8a29e] hover:text-[#44403c] transition-colors px-3 py-1.5"
            >
              Cancel
            </button>
            <button
