...
export const onPortals: Record<string, JurisdictionPortal> = {
  'City of Toronto': {
    ...
    documentTypes: [
      'By-laws (https://www.toronto.ca/city-government/council/city-by-laws/)',
      'Council Agendas and Minutes (https://www.toronto.ca/city-government/council/)',
      'Development Applications (https://www.toronto.ca/city-government/planning-development/)',
      'Open Data Portal (https://open.toronto.ca/)',
      'FIPPA Requests (https://www.toronto.ca/city-government/accountability-operations-customer-service/access-to-city-information/)',
    ],
  },
  'City of Ottawa': {
    name: 'City of Ottawa',
    url: 'https://ottawa.ca/en/city-hall/',
    ...
    documentTypes: [
      'By-laws (https://ottawa.ca/en/city-hall/city-council/by-laws)',
      'Council Meetings (https://ottawa.ca/en/city-hall/city-council)',
      'Development Applications (https://ottawa.ca/en/planning-development-and-construction/planning-and-development)',
      'Open Data (https://open.ottawa.ca/)',
      'FIPPA Requests (https://ottawa.ca/en/city-hall/accountability-and-transparency/access-information)',
    ],
  },
  'City of Mississauga': {
    name: 'City of Mississauga',
    url: 'https://www.mississauga.ca/city-hall/',
    ...
    documentTypes: [
      'By-laws (https://www.mississauga.ca/city-hall/by-laws/)',
      'Council Meetings (https://www.mississauga.ca/city-hall/council-committees/)',
      'Development Applications (https://www.mississauga.ca/development-and-construction/)',
      'FIPPA Requests (https://www.mississauga.ca/city-hall/freedom-of-information/)',
    ],
  },
  'City of Hamilton': {
    name: 'City of Hamilton',
    url: 'https://www.hamilton.ca/city-hall/',
    ...
    documentTypes: [
      'By-laws (https://www.hamilton.ca/city-hall/by-laws-and-legislation/)',
      'Council Meetings (https://www.hamilton.ca/city-hall/council-committee-meetings/)',
      'FIPPA Requests (https://www.hamilton.ca/city-hall/accountability/freedom-information)',
    ],
  },
  'Government of Ontario': {
    ...
    documentTypes: [
      'Ontario Legislation (https://www.ontario.ca/laws)',
      'Open Data Catalogue (https://data.ontario.ca/)',
      'FIPPA Requests (https://www.ontario.ca/page/how-submit-freedom-information-request)',
      'Environmental Registry (https://ero.ontario.ca/)',
    ],
  },
  'Environmental Registry of Ontario': {
    ...
    documentTypes: [
      ...
      'Permit and Approval Notices',
      'Greenbelt and Growth Plan Amendments',
    ],
  },
}
